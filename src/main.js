...
//     if (input) return ($input.value = longStory = input = "");
...
//   if (input.includes("%")) {
//     let percentIndex = input.indexOf("%");
//     let percentValue = parseFloat(input.substring(0, percentIndex));
//     let operation = input.substring(percentIndex - 1, percentIndex);
//     let secondValue = parseFloat(
//       input.substring(percentIndex + 1, input.length - 1),
//     );
//     let result = 0;

//     if (isNaN(percentValue) || isNaN(secondValue)) {
//       $input.value = "Ошибка";
//       return false;
//     }
...
//     switch (operation) {
//       case "+":
//         result = percentValue + (percentValue * secondValue) / 100;
//         break;
//       case "-":
//         result = percentValue - (percentValue * secondValue) / 100;
//         break;
//       case "x":
//         result = percentValue * (secondValue / 100);
//         break;
//       case "/":
//         if (secondValue === 0) {
//           $input.value = "Ошибка";
...
function ev(data) {
  ...
  if (value === "%") {
    ...
    let percentValue = parseFloat(input.substring(0, percentIndex));
    let secondValue = parseFloat(
      input.substring(percentIndex + 1, input.length),
    );
